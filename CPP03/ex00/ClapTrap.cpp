...
/*   Updated: 2021/11/09 17:55:22 by abambi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void)
{
	...
	energy_points = 10;
	attack_damage = 0;
	std::cout << GREEN << "::: New \"" << name << "\" appears!";
...
{
	std::cout << GREEN << "::: Another \"" << src.name << "\" appears: " << RESET;
	std::cout << "\"" << src.name << "\" is copied" << std::endl;
	this->name = src.name;
...
ClapTrap	&ClapTrap::operator=(ClapTrap const &src)
{
	...
	this->energy_points = src.energy_points;
	this->attack_damage = src.attack_damage;
	std::cout << ">>> \"" << this->name << "\" took all characteristics \
from the \"" << src.name << "\"" << std::endl;
...
ClapTrap::~ClapTrap(void)
{
	std::cout << RED << "\"" << name << "\" has disappeared!" << RESET << std::endl;
}
